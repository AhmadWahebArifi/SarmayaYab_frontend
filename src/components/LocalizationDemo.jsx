...
const LocalizationDemo = () => {
  ...
  const handleLanguageChange = async (lang) => {
    ...
    try {
      ...
      showLoader(t("loader.changingLanguage"), false);
          ...
          <div className="space-y-4">
            ...
            <div className="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
              <h3 className="font-medium mb-2">
                {t("stockRequests.form.title")}
              </h3>
              <div className="space-y-2 text-sm">
                <div>
                  {t("stockRequests.form.priority")}:{" "}
                  {t("stockRequests.priorities.normal")}
                </div>
                <div>
                  {t("stockRequests.form.expectedDelivery")}:{" "}
                  {new Date().toLocaleDateString()}
                </div>
                <div>
                  {t("stockRequests.form.notes")}: {t("common.loading")}...
                </div>
              </div>
